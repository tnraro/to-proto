...
export function PhotoPreview({ blob, onRemove, onClick }: { blob: Blob; onRemove: () => void; onClick?: () => void }) {
  const src = useObjectUrl(blob)
  return (
    <div className={`relative h-20 w-20 ${onClick ? 'cursor-pointer' : ''}`} onClick={onClick}>
